...
<script src="/Admin/cgi-bin/datacontrol/widgetCommon.new.js?20110630001" type="text/javascript"></script>
    <script src="<%=AppPath%>/ajax/jquery/ui1.8.1/jquery-1.4.2.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
        ...
        function CreateTabContent() {
            ...
            $.ajax({
                ...
                data: '{"controlPath":"' + decodeURIComponent(ctr) + '"}',
                type: "POST",
                success: function (_result_) {
                    var array = eval(_result_);
                    for (var i in array) {
                        if (array[i].replace(/\./gi, "_") == '<%=CssClass %>')
...
<form id="mainForm" runat="server">
  ...
  <div class="box">
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <tr>
        <td><fieldset style="minheight: 340px; height: auto !important; height: 340px; width: 550px;" id="fieldsetContainer">
          </fieldset></td>
      </tr>
    </table>
