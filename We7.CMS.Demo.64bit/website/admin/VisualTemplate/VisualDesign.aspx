...
<body>
	...
	<div id="warp">
				...
				<a class="publish" id="btnPublish" title="发布">
					<img src="images/publish-button.png" border="0" /></a> <a id="changelayout" title="更换模板">
						<img src="images/theme-button.png" border="0" /></a> <a href="javascript:void(0);"
							...
							</a><a target="_self" id="showHistory" title="历史记录">
								<img src="images/history.png" border="0" />
							</a>
			</div>
		</div>
		...
		<div id="historyBox" class="panelContent">
		<div style="padding-left:50px">
		<a style="cursor: pointer;display:none;"
					class="backtonow">回到当前模版</a>
		<a style="cursor: pointer;"
					class="backuptitle">备份当前模版</a>
					<div>备注：<input title="备注文字" /><input type="button" id="backupbutton" value="备份" />
					<input type="button" id="backupcancel" value="取消" /></div></div>
			<ul class="templates">
				</ul>
		</div>
		<div id="main">
					...
					<div style="z-index: 24;" class="window_inner" id="window_inner_3">
						...
						<div class="window_content" id="widgetList">
							<div id="tooboxhandle" class="window_titleBar" id="window_titleBar_3">
								...
								<div class="window_title titleText" id="window_title_3">We7部件工具箱
                                    <input id="search-widgets" type="text" placeholder="搜索部件" autofocus x-webkit-speech>
                                </div>
							</div>
							<div class="window_bodyArea" id="window_body_3" style="width: 291px; height: 476px;">
								...
								<div id="toolbody" style="overflow-y: hidden; max-height: 376px;" class="loginArea">
									...
									<div id="shopproducts" style="max-height: 376px; overflow-y: auto;display:none">
										<%--<ul>
	...
	<script type="text/javascript">
		...
		$(function () {
		    $("#search-widgets").focus().keyup(function () {
		        ...
		        if ($.trim(text) === '') {
		            $("#widgets>ul>li").show();
		            $("#widgets>ul>li>ul").hide();
		            $("#widgets>ul>li>ul>li").show();
		            return;
		        }
		        //遍历关键字
		        $("#widgets>ul>li").each(function () {
