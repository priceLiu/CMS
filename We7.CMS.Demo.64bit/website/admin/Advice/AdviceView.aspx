...
<asp:content id="We7Content" contentplaceholderid="MyContentPlaceHolder" runat="server">
    ...
    <dl>
        ...
        <div class="toolbar">
            ...
            <asp:Button ID="lnkShow" CssClass="Btn" runat="server" OnClick="lnkShow_Click" Text="审核通过" />
            <asp:Button ID="lnkHide" CssClass="Btn" runat="server" OnClick="lnkHide_Click" Text="审核不通过" />
        </div>
       </div>
