...
We7.Control.registerType("We7.DepartmentEx",
                        ...
                        [{ "Name": "Params.parentId", Type: "TextBox", "Label": "部门父ID" }, { "Name": "Params.role", Type: "TextBox", "Label": "可见的角色ID" }, { Type: "Select", Label: "格式化", Name: "Params.format", Params: [{ Name: "data", Value: "true|是,false|否"}] }, { Type: "Select", Label: "部门过滤", Name: "Params.filter", Params: [{ Name: "data", Value: "false|否,true|是"}]}]);