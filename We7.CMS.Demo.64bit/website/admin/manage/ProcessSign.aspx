<%@ Page Language="C#" MasterPageFile="~/admin/theme/ContentNoMenu.Master" AutoEventWireup="true"
    CodeBehind="ProcessSign.aspx.cs" Inherits="We7.CMS.Web.Admin.ProcessSign" %>
            ...
            <td style="" valign="top">
                <div id="breadcrumb">
                    <h2 class="title">
                        ...
                        您正在审批： <a href="<%=HrefAddress%>" target="_blank">
