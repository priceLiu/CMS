...
<head>
    ...
    <script type="text/javascript">
    	function SearchUserOnClick() {
    		...
    		var searchvalue = $("#<%=SearchTextBox.ClientID %>").val();
    		if (searchvalue == '') $("#DetailGridView tr").show();
    		else {
    			$("#DetailGridView tr").hide();
    			$("#DetailGridView tr:gt(0) td a:contains('" + searchvalue + "')").parents("tr").show();
    		} 
    	}
