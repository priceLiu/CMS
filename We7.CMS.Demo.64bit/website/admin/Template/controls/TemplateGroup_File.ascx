    ...
    <asp:Repeater ID="TempldatesRepeater" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <%# (bool)Eval("IsVisualTemplate") ? "<img src=\"/admin/Images/visual.png\" title=\"可视化模版\" />" : "普通模板"%>
                </td>
                <td>
                ...
                <td>
                    ...
                    | <a href="javascript:void(0)" onclick="javascript:return doDeleteFile('<%#DataBinder.Eval(Container.DataItem, "FileName") %>');">
                        删除 </a>| <a class='bindAction' href="TemplateBindTo.aspx?filename=<%# Eval("FileName", "{0}") %>&file=<%=Request["file"] %>">
                            默认指定</a>
                </td>
            </tr>
        </ItemTemplate>
