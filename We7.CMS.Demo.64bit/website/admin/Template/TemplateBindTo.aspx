<%@ Page Language="C#" MasterPageFile="~/admin/theme/ContentNoMenu.Master" AutoEventWireup="true" CodeBehind="TemplateBindTo.aspx.cs" Inherits="We7.CMS.Web.Admin.TemplateBindTo" Title="指定模板的默认匹配" %>
