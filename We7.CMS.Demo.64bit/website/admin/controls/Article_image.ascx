...
<div id="main">
    ...
    <div class="conbox">
        <div id="conbox">
            ...
            <dl>
                <dd>
                    <asp:Button runat="server" Text="删除原图" ID="DeleteOriginalImgBtn" OnClick="DeleteOriginalImgBtn_Click"/>
                    <asp:Button runat="server" Text="设为非图片文章" ID="SetNoImgBtn" OnClick="SetNoImgArticle"/>
                </dd>
            </dl>
