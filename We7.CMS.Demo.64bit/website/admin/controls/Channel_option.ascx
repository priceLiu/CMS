    ...
    <dl>
        ...
        <dd>
            ...
            <div style="display: none">
                <asp:Button ID="btnDelTitleImg" OnClick="TitleImg_Delete" Text="DeleteImg" runat="server"/>
            ...
            <script type="text/javascript">
                function btnDelImg() {
                    document.getElementById("<%=btnDelTitleImg.ClientID %>").click();
                }

                $(document).ready(function () {
                    $("#<%=TitleImage.ClientID%>").hover(
				     function () {
				         var currElement = $(this).attr("href", "#").removeAttr("target");
				         var offset = currElement.offset();
				         var width = currElement.width();
				         $("<span>").attr("id", "delTitleImg").html("×").css({
				             "position": "absolute",
				             "top": offset.top - 28,
