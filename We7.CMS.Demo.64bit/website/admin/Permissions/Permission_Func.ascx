...
<script type="text/javascript">
	...
	function getMenuIds() {
		...
		$.merge(menu, jQuery.tree.plugins.checkbox.get_undeterminded($.tree.reference($("#menuTree"))));
		//得到节点的id，拼接成字符串
		var ids = "";
	...
	$(document).ready(function () {
		$("#menuTree a.checked").each(function () {
			if ($(this).next("ul").find("a.unchecked").length > 0)
				$(this).removeClass("checked").addClass("undetermined");
		});
	});
</script>
<div id="conbox">
