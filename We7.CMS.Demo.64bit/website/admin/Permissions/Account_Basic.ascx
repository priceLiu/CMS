...
<%--<div id="dvCreateUkey" style="display: none;">
    <div id="prompt" style="color: red; text-align: center;">
        请插入PSA</div>
    <!--页面提示-->
    <input id="ac" name="ac" value="" type="hidden">
    <p>
        * 用 户 名：
        <input id="IID_SecureWeb_I_UserName" name="IID_SecureWeb_I_UserName" size="13" maxlength="128"
            value="" />
        <!--PSA唯一序列号-->
        <input id="IID_SecureWeb_I_SerialNumber" name="IID_SecureWeb_I_SerialNumber" size="20"
            maxlength="32" onpropertychange="psaok();" type="hidden" value="" />
        <!--返回操作结果，0表示成功，其他数值表示错误代码-->
        <input id="IID_SecureWeb_I_Status" name="IID_SecureWeb_I_Status" size="3" maxlength="250"
            onpropertychange="createok();" type="hidden" value="">
    </p>
    <p>
        <!--应用名称-->
        <input id="IID_SecureWeb_I_ApplicationName" name="IID_SecureWeb_I_ApplicationName"
            size="13" maxlength="128" value="<%=ApplicationName%>" type="hidden">
        * 管理密码：
        <input id="IID_SecureWeb_I_AdminPass" name="IID_SecureWeb_I_AdminPass" size="13"
            maxlength="32">
        <!--应用网址-->
        <input id="IID_SecureWeb_I_URL" name="IID_SecureWeb_I_URL" size="30" maxlength="256"
            value="<%=URL%>" type="hidden">
        <!--随机生成的认证码-->
        <input id="IID_SecureWeb_I_SaltValue" name="IID_SecureWeb_I_SaltValue" size="32"
            maxlength="32" value="<%=SaltValue%>" type="hidden">
        <input id="IID_SecureWeb_I_Flag" name="IID_SecureWeb_I_Flag" value="1" type="hidden">
        <input id="IID_SecureWeb_I_Extra" name="IID_SecureWeb_I_Extra" value="" type="text"
            size="50" style="display: none;">
    </p>
    <p>
        <!--创建账户按钮-->
        <input id="IID_SecureWeb_B_Create" name="IID_SecureWeb_B_Create" type="button" value="创建新帐户"
            onclick="gocreate();" disabled="disabled">
    </p>
</div>--%>
