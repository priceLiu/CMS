    ...
    <div class="featured">
        ...
        <div class="container">
            <label for="ValidateCode">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 验证码</label>
            <%--<input type="password" id="LoginPassword" value="" name="data[Login][password]">--%>
            <input name="ValidateCode" type="text" style="width: 70px;" /><img alt="" src="/Admin/cgi-bin/controls/CaptchaImage/SmallJpegImage.aspx"
                style="width: 100px; height: 22px;" />
        </div>
        <div class="container">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="prominent" type="submit">
                &nbsp;登 &nbsp;录&nbsp;</button>
        </div>
