...
<%@ Import Namespace="We7.CMS.Common.PF" %>
...
<div style="float: left; padding-left: 30px;">
    <div class="Login_Common_<%=CssClass %>">
        ...
        <div style="display: <%= LoginNameDisplay %>">
            <%
                Account ac = AccountHelper.GetAccount(Security.CurrentAccountID, null);
            %>
            <%=ac.LoginName%>| <a href="/User/Logout.aspx">退出</a>
        </div>
        ...
        <div class="bottom">
            ...
            <li class="zc" style="display: none;"><a href="/register.aspx">立即注册一个新用户</a></li>
            <li class="clear"></li>
        </div>
        </div>
