...
function AttachmentBuilder(params) {
    ...
    function ShowUploader() {
        ...
        frame.attr("src", Src + "?aid=" + ArticleID + "&t=" + GetTicks() + "&extension=" + FileExtension + "&fileNamePrefix=" + (typeof (params.FileNamePrefix) == "function" ? params.FileNamePrefix.apply(this) : ""));
